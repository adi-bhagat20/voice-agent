...
async def entrypoint(ctx: JobContext) -> None:
    ...
    # ------------------------------------------------------------------
    # 4. Wait for caller to connect to the room
    # ------------------------------------------------------------------
    ...
    try:
        ...
        logger.info("Caller connected to room | identity=%s kind=%s", participant.identity, participant.kind)
        # Small 1s buffer for audio stream stability upon pickup
